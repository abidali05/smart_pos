...
<div class="col-md-6">
<div class="row">
<button type="button" class="btn btn-success short_payment" style="margin-left:15px;" value="50">50 $</button>
<button type="button" class="btn btn-success short_payment" style="margin-left:15px;" value="30">30 $</button>
<button type="button" class="btn btn-success short_payment" style="margin-left:15px;" value="20">20 $</button>
<button type="button" class="btn btn-success short_payment" style="margin-left:15px;" value="10">10 $</button>
</div>
</div>
				</div>
			</div>
