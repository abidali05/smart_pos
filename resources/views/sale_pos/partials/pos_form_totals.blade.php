<div class="row">
	<div class="col-md-12">
	    <button type="button" class="btn btn-primary" style="margin-bottom:50px;" data-toggle="modal" data-target="#exampleModal">
         @lang("lang_v1.right_of_return")
        </button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Calculate Change</h5>
      ...
      <div class="modal-body">
          <form id="calculation_form">
              <div class="row">
                  ...
                  <div class="col-md-6">
                      <input class="form-control " id="receivedamount" />
                  </div>
              </div>
              <br>
              <div class="row">
                  ...
                  <div class="col-md-6">
                      <input class="form-control price_total" id="totalamount" disabled />
                  </div>
              </div>
              <br>
              <div class="row">
                  ...
                  <div class="col-md-6">
                      <input class="form-control price_total" id="returnchange" disabled />
                  </div>
              </div>
          </form>
      </div>
